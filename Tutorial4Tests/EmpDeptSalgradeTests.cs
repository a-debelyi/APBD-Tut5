...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnEmployeesFromChicago()
    {
        ...
        List<Emp> result = emps
            .Where(emp => depts.Any(dept => dept.DeptNo == emp.DeptNo && dept.Loc == "CHICAGO"))
            .ToList();
    ...
    public void ShouldCountEmployeesPerDepartment()
    {
        ...
        var result = emps
            ...
            .Select(emp => new { DeptNo = emp.Key, Count = emp.Count() })
            .ToList();
    ...
    public void ShouldReturnEmployeesWithCommission()
    {
        ...
        // Since there are no nested collections, there is no way to use SelectMany here
        var result = emps
    ...
    public void ShouldReturnEmployeesEarningMoreThanDeptAverage()
    {
        ...
        var result = emps
            .Where(emp => emp.Sal > emps
                .Where(emp2 => emp2.DeptNo == emp.DeptNo)
