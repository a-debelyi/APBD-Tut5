...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnEmployeeManagerPairs()
    {
        ...
        var result = 
            from emp1 in emps
            join emp2 in emps on emp1.Mgr equals emp2.EmpNo
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        var result =
            from emp in emps
            from salgrade in grades
            join dept in depts on emp.DeptNo equals dept.DeptNo
            where emp.Sal >= salgrade.Losal && emp.Sal <= salgrade.Hisal
            select new { emp.EName, dept.DName, salgrade.Grade };
